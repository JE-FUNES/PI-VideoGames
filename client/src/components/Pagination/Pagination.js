...
function Pagination({ gamesPerPage, totalPosts, paginate, currentPage, setCurrentPage }) {
    // Estados
    const [ pageNumberLimit ] = useState(7); // Limite de numeros de paginas 
    const [ maxPageNumberLimit, setMaxPageNumberLimit ] = useState(7); // maximo de numeros de paginas a mostrar
