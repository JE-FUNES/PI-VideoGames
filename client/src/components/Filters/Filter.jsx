  ...
  const handleFilterClick = (filterName) => {
    ...
    return (
        <div className={styles.Filtro}>
            <div style={divStyles}>
      <div
        className={`OrderFilter ${activeFilter === 'OrderFilter' ? 'active' : ''}`}
        onClick={() => handleFilterClick('OrderFilter')}
      >
      </div>
      <div
        className={`CreatedFilter ${activeFilter === 'CreatedFilter' ? 'active' : ''}`}
        onClick={() => handleFilterClick('CreatedFilter')}
      >
      </div>
      <div
        className={`PlatformFilter ${activeFilter === 'PlatformFilter' ? 'active' : ''}`}
        onClick={() => handleFilterClick('PlatformFilter')}
      >
      </div>
      <div
        className={`GenreFilter ${activeFilter === 'GenreFilter' ? 'active' : ''}`}
        onClick={() => handleFilterClick('GenreFilter')}
      >
      </div>
      <div className={`OrderFilterOptions ${activeFilter === 'OrderFilter' ? 'active' : ''}`}>
        <OrderFilter setCurrentPage={setCurrentPage} />
      </div>
      <div className={`CreatedFilterOptions ${activeFilter === 'CreatedFilter' ? 'active' : ''}`}>
        <CreatedFilter setCurrentPage={setCurrentPage} />
      </div>
      <div className={`PlatformFilterOptions ${activeFilter === 'PlatformFilter' ? 'active' : ''}`}>
        <PlatformFilter setCurrentPage={setCurrentPage} />
      </div>
      <div className={`GenreFilterOptions ${activeFilter === 'GenreFilter' ? 'active' : ''}`}>
